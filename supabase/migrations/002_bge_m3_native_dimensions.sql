-- ============================================================
-- Migrate chunk embeddings to BAAI/bge-m3 native dimensions
-- Existing stored vectors are cleared and must be regenerated.
-- After this migration, call POST /api/ingest/reembed to rebuild
-- embeddings for existing chunks with the current model settings.
-- ============================================================

DROP INDEX IF EXISTS idx_chunks_embedding;

DROP FUNCTION IF EXISTS hybrid_search(VECTOR, TEXT, INT, UUID, TEXT);
