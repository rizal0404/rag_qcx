  ...
  return (
    <ReactMarkdown
      ...
      components={{
        ...
        th: ({...props}) => <th className="px-4 py-2 text-left font-semibold text-slate-700 border-b" {...props} />,
        td: ({...props}) => <td className="px-4 py-2 border-b border-slate-100 text-slate-600" {...props} />,
